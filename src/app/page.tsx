      ...
      <div className="container">
        <div className="grid">
          <div className="card">
            ...
            <p className="p">
              Buy MTN bundles for yourself or your customers. Fund your wallet with Paystack,
              place orders, and track delivery from your dashboard.
            </p>
            ...
            <div style={{marginTop:16}} className="notice">
              Tip: Start with small funding to test, then scale your reseller business.
            </div>
          </div>
          <div className="card">
